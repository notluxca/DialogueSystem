...
namespace DialogueSystem.Editor.Utilities
{
    ...
    public static class DSIOUtility
    {
        ...
        public static void Initialize(DSGraphView dsGraphView, string graphName)
        {
            ...
            containerFolderPath = $"{GlobalVariables.DialoguesPath}/{graphName}";
        ...
        public static void Save()
        {
            ...
            DSGraphSaveDataSO graphData = CreateAsset<DSGraphSaveDataSO>(GlobalVariables.DialogueGraphsPath, $"{graphFileName}Graph");
        ...
        private static void CreateDefaultFolders()
        {
            ...
            CreateFolder(GlobalVariables.DialoguesPath, "Graphs");
            CreateFolder(GlobalVariables.DialoguesPath, graphFileName);
